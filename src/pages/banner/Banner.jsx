...
import { banner_title } from "../../components/data/title_names/Title.mjs";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        >
          <Typography id="title_name">Banners</Typography>
          <AddBanner />
        </Stack>
        <Stack mt={2}>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow style={{ background: "#31456A" }}>
                  {banner_title.map((item, i) => {
                    return (
                      <TableCell align="lefft" style={{ color: "#fff" }}>
                        {item.title}
                      </TableCell>
                    );
                  })}
