      ...
      >
        <Box sx={style}>
          <Stack
            ...
            alignItems="center"
          >
            <Typography id="add_modal_title"> Update TmMuseCard</Typography>
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={6}>
              <OwnTextField type="number" label="Date of birth :" />
            </Grid>
            <Grid item xs={12} sm={6} md={6}>
              <OwnTextField label="Passport info :" />
            </Grid>
            <Grid item xs={12} sm={6} md={6}>
              <OwnTextField label="Passport info :" />
            </Grid>
...
export default UpdateTmMuseCard;
